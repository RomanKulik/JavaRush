...
должен вызвать метод сабкласса FirstClass, если param > 0,
...
3. В методе someAction анонимного класса Action созданного в классе
Solution должен содержаться вызов метода someAction родительского класса (super.someAction()).
4. В методе someAction анонимного класса Action созданного в классе
Solution должен быть создан объект типа FirstClass.
5. В методе someAction анонимного класса Action созданного в классе
Solution должен быть создан объект типа SecondClass.
*/
...
public class Solution implements Action {
    ...
    private Action solutionAction = new Action() {
        ...
        public void someAction() {
            ...
            // Подсказка: метод someAction анонимного класса поля solutionAction
            // должен вызвать метод сабкласса FirstClass, если param > 0,
            // иначе вызвать метод сабкласса SecondClass.
