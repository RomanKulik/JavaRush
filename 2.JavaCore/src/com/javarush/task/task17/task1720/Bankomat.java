...
2. Метод deposit(String money) класса BankAccount
должен делегировать поведение в метод deposit(BigDecimal money).
3. Метод withdraw(String money) класса BankAccount
должен делегировать поведение в метод withdraw(BigDecimal money).
...
Ибо, да вспомним золотые слова Великого Эккеля:
"Это одна из проблем многопоточных программ -
на первый взгляд они работают нормально, тогда,
как на самом деле в них присутствует ошибка,
просто ее вероятность очень низка."
 */
