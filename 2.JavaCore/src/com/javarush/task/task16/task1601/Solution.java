...
/* 
My first thread
Вот и наступил этот знаменательный момент!
Крепитесь: вам предстоит создать свою собственную нить (или поток, если угодно).
Создайте public static class TestThread — нить с интерфейсом Runnable.
