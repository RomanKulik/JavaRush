...
/* 
Часы
Классические террианские часы делают "тик-так".
И в нашей программе они должны звучать так же.
Разберитесь, что делает программа и реализуйте логику метода printTikTak.
Через первые полсекунды должна в консоль метод должен выводить фразу Tik,
через вторые полсекунды — Tak.
...
3. Метод printTikTak должен два раза заснуть на полсекунды.
 Используй метод Thread.sleep(500).
