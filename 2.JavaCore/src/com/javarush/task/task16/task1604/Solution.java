...
/* 
Вывод стек-трейса
Вы еще помните о трассировке стека и о том,
что запускаемый в настоящий момент метод находится на вершине стека?
Будем вспоминать, решая задачу:
вам предстоит создать таск
(public static класс SpecialThread, который реализует интерфейс Runnable).
