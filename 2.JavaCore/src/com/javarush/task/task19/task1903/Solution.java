...
6. В классе IncomeDataAdapter реализуй методы интерфейсов
Customer и Contact используя подсказки в виде комментариев в интерфейсах.
*/
...
public class Solution {
    ...
    public static void main(String[] args) {
        Contact phone = new IncomeDataAdapter(new IncomeData() {
            @Override
    ...
    public static class IncomeDataAdapter implements Customer, Contact {
        ...
        public String getName() {
            String s = this.data.getContactLastName()
                    .concat(", ")
        ...
        public String getPhoneNumberMaskFormater() {
            String phoneNumWithCode = data.getCountryPhoneCode() +
            ...
            try {
                ...
                returnString = maskFormatter.valueToString(phoneNumWithCode);
