...
/* 
Template pattern
Создадим алгоритм работы баристы в классе DrinkMaker.
Он будет выбирать подходящую чашку,
класть ингридиенты и заливать жидкостью.
Также создадим узкоспециализированные алгоритмы для чая и латте,
унаследовав их от DrinkMaker.
...
3. В отдельных файлах создать классы LatteMaker и TeaMaker,
которые наследуются от DrinkMaker.
...
public class Solution {
    public static void main(String[] args) {
        DrinkMaker tm = new TeaMaker();
        tm.makeDrink();

        DrinkMaker lm = new LatteMaker();
        lm.makeDrink();
    }
}
/*public class Solution {
