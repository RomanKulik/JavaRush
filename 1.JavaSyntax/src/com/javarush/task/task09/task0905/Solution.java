...
Помните золотое правило: функция А вызывает функцию Б,
а та вызывает функцию В. И чтобы выйти из А, надо сначала выйди из Б,
а для этого надо выйти из В.
Вспомнили? Вот и хорошо.
А тепер напишем метод, который возвращает результат – глубину его стек-трейса –
количество методов в нем (количество элементов в списке).
И ещё: пускай это число метод выведет на экран.
