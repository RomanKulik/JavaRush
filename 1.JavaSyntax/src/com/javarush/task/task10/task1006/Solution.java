...
Мы тут почему стараемся? Хотим, чтобы вы усвоили эти приемы так,
чтобы не приходилось переучиваться.
В этот раз в нашей задаче операторов приведения типов слишком много,
затесались лишние. Найдите их и уберите, чтобы получить требуемый ответ.
