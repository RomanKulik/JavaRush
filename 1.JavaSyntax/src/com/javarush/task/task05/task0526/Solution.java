...
/*public class Solution {
    ...
    //напишите тут ваш код
    Ошибка в файле com/javarush/task/task05/task0526/Solution.java в строке 39
Distance between variable 'woman2' declaration and its first usage is 4, but allowed 3.
Consider to make that variable as final if you still need to store its value in advance
(before method calls that might do side effect on original value).
}*/

public class Solution {
    public static void main(String[] args) {
        //напишите тут ваш код
        Man man1 = new Man("Sergey", 22, "Vinnycya");
        man1.toString(1);
        Man man2 = new Man("Senya", 23, "Vuyky");
        man2.toString(1);
        Woman woman1 = new Woman("Sveta", 24, "Vnukovo");
        woman1.toString(1);
        Woman woman2 = new Woman("Tanya", 3, "Moskva");
        woman2.toString(1);
